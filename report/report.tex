...
\mypar{EF} \textit{Experimental setup} The tests were performed on a Intel i7 6700HQ (Skylake) with TurboBoost disabled, compiled with \texttt{gcc} with flags \texttt{-O3 -fno-tree-vectorize}.
