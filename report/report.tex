...
-ilp doesn't help, pipeline already filled with some computations
-loop invariant code was removed (didn't modify flop count), and achieve max based on instruction mix of 3

\mypar{SIMD vectorization}
-vectorize across points: each point ...
