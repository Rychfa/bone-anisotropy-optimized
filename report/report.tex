...
\begin{abstract}
In this paper, we optimized an implementation for bone anisotropy mapping.
\end{abstract}
...
\mypar{EF} \textit{Experimental setup} The tests were performed on a Intel i7 6700HQ (Skylake) with TurboBoost disabled, compiled with \texttt{gcc} with flags \texttt{-O3 -fno-tree-vectorize -mavx2}.
