...
#define LOAD_PREV_3D(vecID) \
    switch (vecID) {                                                                              \
        ...
        case 11: /* Vector (1,1,-1) */                                                             \
            prev1 = (ib > 0) ? 1 : 0;                                                                                            \
            prev2 = (ib > 0 && jb+j2 > 0) ? 1 : 0;                                                                               \
            prev_mask1 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k1+prev1)*n*n        + (jb+j1-prev1)*n        + (ib+i-prev1)  ]        > 0.5;     \
            prev_mask2 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k1-STRIDE+prev1)*n*n + (jb+j1-prev1)*n        + (ib+i-prev1)  ]        > 0.5;     \
            prev_mask3 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k2+prev2)*n*n        + (jb+j2-prev2)*n        + (ib+i-prev2)  ]        > 0.5;     \
            prev_mask4 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k2+prev1)*n*n        + (jb+j2+STRIDE-prev1)*n + (ib+i-prev1)  ]        > 0.5;     \
                                                                                                                                 \
            prev3 = (jb > 0) ? 1 : 0;                                                                                            \
            prev4 = (jb > 0 && kb+BLOCK_SIZE-1-j2 < n-1) ? 1 : 0;                                                                               \
            prev_mask5 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j1+prev3)*n*n        + (jb+i-prev3)*n         + (ib+k1)-prev3 ]        > 0.5;     \
            prev_mask6 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j1+prev3)*n*n        + (jb+i-prev3)*n         + (ib+k1+STRIDE)-prev3 ] > 0.5;     \
            prev_mask7 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j2+prev4)*n*n        + (jb+i-prev4)*n         + (ib+k2)-prev4 ]        > 0.5;     \
            prev_mask8 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j2-STRIDE+prev3)*n*n + (jb+i-prev3)*n         + (ib+k2)-prev3 ]        > 0.5;     \
                                                                                                                                 \
            prev5 = (kb+BLOCK_SIZE-1-i < n-1) ? 1 : 0;                                                                                            \
            prev6 = (kb+BLOCK_SIZE-1-i < n-1 && ib+j2 > 0) ? 1 : 0;                                                                               \
            prev_mask9  = hr_sphere_region[ (kb+BLOCK_SIZE-1-i+prev5)*n*n        + (jb+k1-prev5)*n         + (ib+j1-prev5) ]       > 0.5;     \
            prev_mask10 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i+prev5)*n*n        + (jb+k1+STRIDE-prev5)*n  + (ib+j1-prev5) ]       > 0.5;     \
            prev_mask11 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i+prev6)*n*n        + (jb+k2-prev6)*n         + (ib+j2-prev6) ]       > 0.5;     \
            prev_mask12 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i+prev5)*n*n        + (jb+k2-prev5)*n         + (ib+j2+STRIDE-prev5)] > 0.5;     \
            break;                                                                                                               \
        ...
        case 13: /* Vector (-1,1,1) */                                                             \
            ...
            prev_mask1 = hr_sphere_region[ (kb+k1-prev1)*n*n        + (jb+j1-prev1)*n        + (ib+BLOCK_SIZE-1-i+prev1)  ]        > 0.5;     \
            prev_mask2 = hr_sphere_region[ (kb+k1+STRIDE-prev1)*n*n + (jb+j1-prev1)*n        + (ib+BLOCK_SIZE-1-i+prev1)  ]        > 0.5;     \
            prev_mask3 = hr_sphere_region[ (kb+k2-prev2)*n*n        + (jb+j2-prev2)*n        + (ib+BLOCK_SIZE-1-i+prev2)  ]        > 0.5;     \
            prev_mask4 = hr_sphere_region[ (kb+k2-prev1)*n*n        + (jb+j2+STRIDE-prev1)*n + (ib+BLOCK_SIZE-1-i+prev1)  ]        > 0.5;     \
                                                                                                                                 \
            prev3 = (jb > 0) ? 1 : 0;                                                                                            \
            prev4 = (jb > 0 && kb+j2 > 0) ? 1 : 0;                                                                               \
            prev_mask5 = hr_sphere_region[ (kb+j1-prev3)*n*n        + (jb+i-prev3)*n         + (ib+BLOCK_SIZE-1-k1+prev3) ]        > 0.5;     \
            prev_mask6 = hr_sphere_region[ (kb+j1-prev3)*n*n        + (jb+i-prev3)*n         + (ib+BLOCK_SIZE-1-k1-STRIDE+prev3) ] > 0.5;     \
            prev_mask7 = hr_sphere_region[ (kb+j2-prev4)*n*n        + (jb+i-prev4)*n         + (ib+BLOCK_SIZE-1-k2+prev4) ]        > 0.5;     \
            prev_mask8 = hr_sphere_region[ (kb+j2+STRIDE-prev3)*n*n + (jb+i-prev3)*n         + (ib+BLOCK_SIZE-1-k2+prev3) ]        > 0.5;     \
                                                                                                                                 \
            prev5 = (kb > 0) ? 1 : 0;                                                                                            \
            prev6 = (kb > 0 && ib+BLOCK_SIZE-1-j2 < n-1) ? 1 : 0;                                                                               \
            prev_mask9  = hr_sphere_region[ (kb+i-prev5)*n*n        + (jb+k1-prev5)*n         + (ib+BLOCK_SIZE-1-j1+prev5) ]       > 0.5;     \
            prev_mask10 = hr_sphere_region[ (kb+i-prev5)*n*n        + (jb+k1+STRIDE-prev5)*n  + (ib+BLOCK_SIZE-1-j1+prev5) ]       > 0.5;     \
            prev_mask11 = hr_sphere_region[ (kb+i-prev6)*n*n        + (jb+k2-prev6)*n         + (ib+BLOCK_SIZE-1-j2+prev6) ]       > 0.5;     \
            prev_mask12 = hr_sphere_region[ (kb+i-prev5)*n*n        + (jb+k2-prev5)*n         + (ib+BLOCK_SIZE-1-j2-STRIDE+prev5)] > 0.5;     \
            break;                                                                                \
        default: ;                                                                                \
    }

#define LOAD_DATA_3D(vecID) \
    switch (vecID) {                                                                              \
        case 10: /* Vector (1,1,1) */                                                             \
            ...
            break;                                                                                            \
        case 11: /* Vector (1,1,-1) */                                                                        \
            r1 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k1)*n*n        + (jb+j1)*n        + (ib+i)  ];                         \
            r2 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k1-STRIDE)*n*n + (jb+j1)*n        + (ib+i)  ];                         \
            r3 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k2)*n*n        + (jb+j2)*n        + (ib+i)  ];                         \
            r4 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k2)*n*n        + (jb+j2+STRIDE)*n + (ib+i)  ];                         \
                                                                                                              \
            r5 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j1)*n*n        + (jb+i)*n         + (ib+k1) ];                         \
            r6 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j1)*n*n        + (jb+i)*n         + (ib+k1+STRIDE) ];                  \
            r7 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j2)*n*n        + (jb+i)*n         + (ib+k2) ];                         \
            r8 = hr_sphere_region[ (kb+BLOCK_SIZE-1-j2-STRIDE)*n*n + (jb+i)*n         + (ib+k2)];                          \
                                                                                                              \
            r9  = hr_sphere_region[ (kb+BLOCK_SIZE-1-i)*n*n        + (jb+k1)*n         + (ib+j1) ]      ;                  \
            r10 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i)*n*n        + (jb+k1+STRIDE)*n  + (ib+j1) ]      ;                  \
            r11 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i)*n*n        + (jb+k2)*n         + (ib+j2) ]      ;                  \
            r12 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i)*n*n        + (jb+k2)*n         + (ib+j2+STRIDE)];                  \
            break;                                                                                            \
        case 12: /* Vector (1,-1,1) */                                                                        \
            ...
            break;                                                                                \
        case 13: /* Vector (-1,1,1) */                                                             \
            r1 = hr_sphere_region[ (kb+k1)*n*n        + (jb+j1)*n        + (ib+BLOCK_SIZE-1-i)  ];         \
            r2 = hr_sphere_region[ (kb+k1+STRIDE)*n*n + (jb+j1)*n        + (ib+BLOCK_SIZE-1-i)  ];                         \
            r3 = hr_sphere_region[ (kb+k2)*n*n        + (jb+j2)*n        + (ib+BLOCK_SIZE-1-i)  ];                         \
            r4 = hr_sphere_region[ (kb+k2)*n*n        + (jb+j2+STRIDE)*n + (ib+BLOCK_SIZE-1-i)  ];                         \
                                                                                                              \
            r5 = hr_sphere_region[ (kb+j1)*n*n        + (jb+i)*n         + (ib+BLOCK_SIZE-1-k1) ];                         \
            r6 = hr_sphere_region[ (kb+j1)*n*n        + (jb+i)*n         + (ib+BLOCK_SIZE-1-k1-STRIDE) ];                  \
            r7 = hr_sphere_region[ (kb+j2)*n*n        + (jb+i)*n         + (ib+BLOCK_SIZE-1-k2) ];                         \
            r8 = hr_sphere_region[ (kb+j2+STRIDE)*n*n + (jb+i)*n         + (ib+BLOCK_SIZE-1-k2)];                          \
                                                                                                              \
            r9  = hr_sphere_region[ (kb+i)*n*n        + (jb+k1)*n         + (ib+BLOCK_SIZE-1-j1) ]      ;                  \
            r10 = hr_sphere_region[ (kb+i)*n*n        + (jb+k1+STRIDE)*n  + (ib+BLOCK_SIZE-1-j1) ]      ;                  \
            r11 = hr_sphere_region[ (kb+i)*n*n        + (jb+k2)*n         + (ib+BLOCK_SIZE-1-j2) ]      ;                  \
            r12 = hr_sphere_region[ (kb+i)*n*n        + (jb+k2)*n         + (ib+BLOCK_SIZE-1-j2-STRIDE)];                  \
            break; \
        default: ;                                                                                \
    }

#define LOAD_PREV_REMAINDER_3D(vecID) \
    switch (vecID) {                                                                              \
        case 10: /* Vector (1,1,1) */                                                             \
            prev1 = (ib > 0) ? 1 : 0;          \
        ...
        case 11: /* Vector (1,1,-1) */                                                             \
            prev1 = (ib > 0) ? 1 : 0;          \
            prev2 = (ib > 0 && jb+j > STRIDE) ? 1 : 0;    \
            prev_mask1 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k+prev1)*n*n        + (jb+j-prev1)*n        + (ib+i-prev1)        ] > 0.5;  \
            prev_mask2 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k+prev2)*n*n        + (jb+j-STRIDE-prev2)*n + (ib+i-prev2)        ] > 0.5;  \
                                                                                                                           \
            prev3 = (jb > 0) ? 1 : 0;                                                                                      \
            prev4 = (jb > 0 && kb+BLOCK_SIZE-1-k+STRIDE < n-1) ? 1 : 0;                                                                     \
            prev_mask5 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k+prev3)*n*n        + (jb+i-prev3)*n        + (ib+j-prev3)        ] > 0.5;  \
            prev_mask6 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k+STRIDE+prev4)*n*n + (jb+i-prev4)*n        + (ib+j-prev4)        ] > 0.5;  \
                                                                                                                           \
            prev5 = (kb+BLOCK_SIZE-1-i < n-1) ? 1 : 0;                                                                                      \
            prev6 = ((kb+BLOCK_SIZE-1-i < n-1) && ib+j > STRIDE) ? 1 : 0;                                                                     \
            prev_mask9  = hr_sphere_region[ (kb+BLOCK_SIZE-1-i+prev5)*n*n       + (jb+k-prev5)*n        + (ib+j-prev5)        ] > 0.5;  \
            prev_mask10 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i+prev6)*n*n       + (jb+k-prev6)*n        + (ib+j-STRIDE-prev6) ] > 0.5;  \
            break;                                                                                             \
        case 12: /* Vector (1,-1,1) */                                                             \
            prev1 = (ib > 0) ? 1 : 0;                                                                                     \
        ...
        case 13: /* Vector (-1,1,1) */                                                             \
            ...
            prev_mask1 = hr_sphere_region[ (kb+k-prev1)*n*n        + (jb+j-prev1)*n        + (ib+BLOCK_SIZE-1-i+prev1)        ] > 0.5;  \
            prev_mask2 = hr_sphere_region[ (kb+k-prev2)*n*n        + (jb+j-STRIDE-prev2)*n + (ib+BLOCK_SIZE-1-i+prev2)        ] > 0.5;  \
                                                                                                                           \
            prev3 = (jb > 0) ? 1 : 0;                                                                                      \
            prev4 = (jb > 0 && kb+k > STRIDE) ? 1 : 0;                                                                     \
            prev_mask5 = hr_sphere_region[ (kb+k-prev3)*n*n        + (jb+i-prev3)*n        + (ib+BLOCK_SIZE-1-j+prev3)        ] > 0.5;  \
            prev_mask6 = hr_sphere_region[ (kb+k-STRIDE-prev4)*n*n + (jb+i-prev4)*n        + (ib+BLOCK_SIZE-1-j+prev4)        ] > 0.5;  \
                                                                                                                           \
            prev5 = (kb > 0) ? 1 : 0;                                                                                      \
            prev6 = (kb > 0 && ib+BLOCK_SIZE-1-j+STRIDE < n-1) ? 1 : 0;                                                                     \
            prev_mask9  = hr_sphere_region[ (kb+i-prev5)*n*n       + (jb+k-prev5)*n        + (ib+BLOCK_SIZE-1-j+prev5)        ] > 0.5;  \
            prev_mask10 = hr_sphere_region[ (kb+i-prev6)*n*n       + (jb+k-prev6)*n        + (ib+BLOCK_SIZE-1-j+STRIDE+prev6) ] > 0.5;  \
            break;                                                                                             \
        default: ;                                                                                \
    }

#define LOAD_DATA_REMAINDER_3D(vecID) \
    switch (vecID) {                                                                              \
        case 10: /* Vector (1,1,1) */                                                             \
        ...
        case 11: /* Vector (-1,0,1) */                                                             \
            r1 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k)*n*n        + (jb+j)*n        + (ib+i)        ];         \
            r2 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k)*n*n        + (jb+j-STRIDE)*n + (ib+i)        ];         \
                                                                                                  \
            r5 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k)*n*n        + (jb+i)*n        + (ib+j)        ];         \
            r6 = hr_sphere_region[ (kb+BLOCK_SIZE-1-k+STRIDE)*n*n + (jb+i)*n        + (ib+j)        ];         \
                                                                                                  \
            r9  = hr_sphere_region[ (kb+BLOCK_SIZE-1-i)*n*n       + (jb+k)*n        + (ib+j)        ];         \
            r10 = hr_sphere_region[ (kb+BLOCK_SIZE-1-i)*n*n       + (jb+k)*n        + (ib+j-STRIDE) ];         \
            break;                                                                                \
        case 12: /* Vector (1,-1,1) */                                                             \
            ...
            break;                                                                                \
        case 13: /* Vector (-1,1,1) */                                                             \
            r1 = hr_sphere_region[ (kb+k)*n*n        + (jb+j)*n        + (ib+BLOCK_SIZE-1-i)        ];         \
            r2 = hr_sphere_region[ (kb+k)*n*n        + (jb+j-STRIDE)*n + (ib+BLOCK_SIZE-1-i)        ];         \
                                                                                                  \
            r5 = hr_sphere_region[ (kb+k)*n*n        + (jb+i)*n        + (ib+BLOCK_SIZE-1-j)        ];         \
            r6 = hr_sphere_region[ (kb+k-STRIDE)*n*n + (jb+i)*n        + (ib+BLOCK_SIZE-1-j)        ];         \
                                                                                                  \
            r9  = hr_sphere_region[ (kb+i)*n*n       + (jb+k)*n        + (ib+BLOCK_SIZE-1-j)        ];         \
            r10 = hr_sphere_region[ (kb+i)*n*n       + (jb+k)*n        + (ib+BLOCK_SIZE-1-j+STRIDE) ];         \
            break;                                                                                \
        default: ;                                                                                \
    }

#define DIAGONAL_3D(vecID) \
    switch (vecID) {                                                                              \
        case 10:                                                                                  \
            ...
            break;                                                                                \
        case 11: /* Vector (1,1,-1) */                                                            \
            prev1 = (kb+BLOCK_SIZE-1 < n-1 && jb > 0 && ib > 0) ? 1 : 0;                                          \
            prev_mask1 = hr_sphere_region[ (kb+BLOCK_SIZE-1+prev1)*n*n + (jb-prev1)*n + (ib-prev1) ] > 0.5;    \
            for (int i = 0; i < BLOCK_SIZE; ++i) {                                                \
                r1 = hr_sphere_region[ (kb+BLOCK_SIZE-i-1)*n*n + (jb+i)*n + (ib+i)];                           \
                acc1 += r1;                                                                       \
                curr_mask1 = r1 > 0.5;                                                            \
                edge_count1 += curr_mask1 ^ prev_mask1;                                           \
                prev_mask1 = curr_mask1;                                                          \
        ...
        case 12: /* Vector (1,-1,1) */                                                            \
            ...
            break;                                                                                \
        case 13: /* Vector (-1,1,1) */                                                            \
            prev1 = (kb >0 && jb > 0 && ib+BLOCK_SIZE-1 < n-1) ? 1 : 0;                                          \
            prev_mask1 = hr_sphere_region[ (kb-prev1)*n*n + (jb-prev1)*n + (ib+BLOCK_SIZE-1+prev1) ] > 0.5;    \
            for (int i = 0; i < BLOCK_SIZE; ++i) {                                                \
                r1 = hr_sphere_region[ (kb+i)*n*n + (jb+i)*n + (ib+BLOCK_SIZE-i-1)];                           \
                acc1 += r1;                                                                       \
                curr_mask1 = r1 > 0.5;                                                            \
                edge_count1 += curr_mask1 ^ prev_mask1;                                           \
                prev_mask1 = curr_mask1;                                                          \
...
#define BLOCK_KERNEL_3D(vec, kb, jb, ib) \
{                                                                                                                    \
    const int vecID = vec;                                                                                           \
    double bone_length_block = 0.0;                                                                                  \
    int intercepts_block = 0;                                                                                        \
