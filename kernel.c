...
void init(double **sphere, double **extracted_region, double **ptrHighRes, double **ptrLowRes, double **rotation_matrix,
          double **ptrEvecOut, double **ptrEvalsOut) {
    //
    // Create sphere mask
    //
    ...
    *ptrEvalsOut = calloc(sizeof(double), 3 * LOW_RES_SIZE);
    ...
    fit_ellipsoid_debug_init();
#endif
    fit_ellipsoid_simd_points_init();
}

void deInit(double *sphere, double *extracted_region, double *ptrHighRes, double *ptrLowRes, double *rotation_matrix,
            double *ptrEvecOut, double *ptrEvalsOut, bool generate_ground_truth) {
...
void
kernel_basic(double *sphere, double *extracted_region, double *ptrHighRes, double *ptrLowRes, double *rotation_matrix,
             double *ptrEvecOut, double *ptrEvalsOut) {
    ...
    region_extraction_simd(798, 413, 976, sphere, extracted_region, ptrHighRes);
    ptrEvalsOut[0 * 3] = extracted_region[0];
...
// Optimized version
void
kernel_opt1(double *sphere, double *extracted_region, double *ptrHighRes, double *ptrLowRes, double *rotation_matrix,
            double *ptrEvecOut, double *ptrEvalsOut) {
    double xT, yT, zT, xC, yC, zC;
